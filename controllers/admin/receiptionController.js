  ...
  try {
    ...
    if (file) {
      ...
      const fileMetadata = {
        ...
        parents: ["1MKYZ4fIUzERPyYzL_8I101agWemxVXts"], // Replace with your shared folder ID
      };
      const media = {
...
<body>
    <div class="header">
        <img src="https://res.cloudinary.com/dnznafp2a/image/upload/v1738748712/bagul-presc_sthcu0.png" alt="Hospital Logo" />
        <h1>Hospital Bill</h1>
    </div>
...
<body>
    <div class="container">
        <div class="header">
            <img src="https://res.cloudinary.com/dnznafp2a/image/upload/v1738748712/bagul-presc_sthcu0.png" alt="header">
        </div>
        <div class="details">
